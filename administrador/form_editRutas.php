        ...
        <div class="editarParada">
            <div class="panel panel-success" >
                ...
                <div class="panel-heading" >
                    <h5 class="headingParadas">Editar Informacion de las Rutas</h5>
                </div>
                <div class="panel-body">
                    <div class="container-fluid">

                        <form role="form" name="nuevaRuta" method="POST" action="editarRutas.php?id_ruta=<?php echo $con['id_ruta']; ?>">
