        ...
        <div class="editarParada">
            <div class="panel panel-success" >
                ...
                <div class="panel-body">
                    <div class="container-fluid">
                        <form role="form" name="deleteParada" method="POST" action="deleteParada.php?id_paradas=<?php echo $con["id_paradas"]; ?>" onsubmit="return confirmation();">
                            <div class="modal-body">  
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="Direccion" name="Direccion" value="<?php echo $con['direccion']; ?>" disabled>

                                </div>
                                <div class="input-group"> 
                                    <label for="latit">Latitud</label>
                                    <input type="text" class="form-control" id="Latitud" name="Latitud"  aria-describedby="sizing-addon2" value="<?php echo $con['latitud']; ?>" disabled>
                                </div>
                                <div class="input-group"> 
                                    <label for="longit">Longitud</label>
                                    <input type="text" class="form-control" id="Longitud" name="Longitud"  aria-describedby="sizing-addon2" value="<?php echo $con['longitud']; ?>" disabled>
                                ...
                                <div class="input-group">                               
                                    ...
                                    <select class="form-control" id="idruta" name="idruta" disabled>                                                    
                            ...
                            <div class="modal-footer">
                                ...
                                <button   type="submit" href="home.php" class="btn btn-success">Continuar</button>
                                <a  type="button" href="home.php" class="btn btn-danger" >Cancelar</a>                                   
                            </div>
                        </form>
                    </div>
                </div>
