...
<html>
    <head>
        ...
        <style>
            ...
            #map { position:relative; top:auto; bottom:auto; width:100%;  }
            #pagina3 {margin-left: 3%; width: 61%;   }
            #Lista{    margin-left: 63%;  position: absolute;}
    ...
    <body >
        ...
        <div id="pagina3" class="container">
            ...
            <div id="Lista" >
                ...
                $resultado = mysqli_query($con, "SELECT * FROM horarios");
                while ($ruta = $resultado->fetch_array()) {
                    $id = $ruta['id_ruta'];
                    $inicio = $ruta['incio'];
                    $fin = $ruta['destino'];
                    $linea = $ruta['numeroDeLinea'];

                    echo"<div class='panel panel-info'>";
                    echo"<div class='panel-heading'>";
                    echo" <h4 class='panel-title'>";
                    echo " <a data-toggle='collapse' data-parent='#accordion' href='#$id'>$inicio - $fin </a></h4>";
                    echo "</div>";

                    echo"<div id='$id' class='panel-collapse collapse'>";
                    echo "<div class='panel-body'> $linea <p>kajdajksdhasjkdhjaskdhasdsfsfsdfsdfs</p><p>sdasdasdasdasdasdasd</p></div>";
                    echo"</div>";
                    echo"</div>";
                    $id = '';
                }
